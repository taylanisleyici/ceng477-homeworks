...
vec3 I = vec3(1.0, 0.0, 0.0);     // Hot color for point light intensity
vec3 Iamb = vec3(0.9, 0.2, 0.2);   // Ambient light intensity
vec3 kd = vec3(0.8, 0.2, 0.2);      // Diffuse reflectance coefficient
